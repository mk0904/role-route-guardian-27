      ...
      <CardContent className="p-4 sm:p-6">
          ...
          <div className="flex items-end gap-1">
            {isLoading ? (
              ...
              <>
                ...
                {suffix && <span className="text-xl sm:text-2xl mb-1 text-slate-600">{suffix}</span>}
              </>
            )}
          </div>
        ...
        {typeof change === 'number' && (
          <div className="mt-3 flex items-center text-sm">
            ...
            <span className="ml-2 text-slate-500 text-xs sm:text-sm">vs last month</span>
          </div>
        )}
      </CardContent>
    </Card>
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:flex-wrap justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold">Welcome, Channel HR User</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6">
        <div className="bg-white rounded-lg border shadow-sm lg:col-span-2">
          <div className="p-4 sm:p-6 border-b">
            <h2 className="text-lg sm:text-xl font-bold">Branch Visit Coverage by Category</h2>
            <div className="mt-1 text-xs sm:text-sm font-medium text-slate-500">Current Month</div>
          </div>
              ...
              <>
                {categoryStats.map((category, index) => (
                  <div key={index} className="space-y-2">
                    <div className="flex justify-between items-center text-sm sm:text-base flex-wrap">
                    ...
                    <div className="h-2 sm:h-3 rounded-full bg-slate-200 overflow-hidden">
                      <div 
        ...
        <div className="bg-white rounded-lg border shadow-sm">
          <div className="p-4 sm:p-6 border-b">
            <h2 className="text-lg sm:text-xl font-bold">Monthly Trend</h2>
          </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                {monthlyTrends.map((month, i) => (
                  <div key={i} className="flex items-center gap-2 sm:gap-3">
                    <div className="w-20 sm:w-28 text-xs sm:text-sm text-slate-600">{month.month}</div>
          ...
          <div className="p-4 sm:p-6 border-t mt-4 sm:mt-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold text-base sm:text-lg">Top Performers</h3>
              ...
              <div className="space-y-3">
                {topPerformers.map((performer, i) => (
                  <div key={i} className="flex justify-between items-center">
                    ...
                    <span className="px-2 py-0.5 text-xs sm:text-sm rounded bg-green-50 text-green-700">
